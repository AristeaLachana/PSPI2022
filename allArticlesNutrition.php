...
<a href="readmore.php?post-slug=<?php echo $post['slug']; ?>"><strong><?php echo $post['title'] ?> - <?php echo $post['author']; ?></strong></a><br><br><?php echo $post['description']?><a href="readmore.php?post-slug=<?php echo $post['slug']; ?>" style="color:grey;">...Διαβάστε περισσότερα</a>
</div>
<?php endforeach ?>
<div class="center">
